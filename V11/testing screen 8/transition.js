export function textTransition(div, endText) {
    ...
    // Choose the desired effect by uncommenting one of the following lines
    // and commenting the others
   // randomizeIndexes(indexes); // Random effect
    //sequentialIndexes(indexes); // Sequential effect
    // wavePatternIndexes(indexes); // Wave pattern effect
    // centerOutwardIndexes(indexes, maxText); // Center outward effect
